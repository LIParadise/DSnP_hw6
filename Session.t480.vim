...
silent only
cd /mnt/data/Document/DSnP/DSnP_hw6
...
silent! normal! zE
let s:l = 110 - ((22 * winheight(0) + 20) / 40)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 36 - ((14 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
exe 'vert 3resize ' . ((&columns * 81 + 79) / 159)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 257 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
257
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((15 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 520 - ((4 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
520
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((24 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 175 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175

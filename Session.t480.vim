...
silent! normal! zE
let s:l = 55 - ((26 * winheight(0) + 20) / 40)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 82 - ((16 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 243 - ((34 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
243
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 449 - ((8 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
449
